...
if __name__ == "__main__":
    print("\n=== TEST QUERIES.PY — Projet Immobilier ===\n")
    ...
    get_data_quality("maisons")

    # 3. Stats par groupe
    get_stats_groupe("maisons", groupe="Neighborhood", cible="SalePrice")

    # 4. Anomalies
    get_anomalies("maisons", regles=[
        '"SalePrice" < 0',
        '"GrLivArea" < 0'
    ])
    ...
    print("\n✅ queries.py OK — prêt pour le projet immo !")